@extends('layouts.pos', ['title' => 'Transaction Detail'])

@section('content')
    <div class="w-full min-h-screen p-6 flex items-center justify-center">
        <div class="max-w-xl w-full bg-white p-5 rounded shadow-xl">
            <h1 class="text-2xl">Transaction {{ $transaction->code }}</h1>
            ...
            <div class="mt-5">
                ...
                <div class="mt-4 grid grid-cols-3 gap-2">
                    ...
                    <a href="{{ route('pos.index') }}" class="py-2 text-lg bg-red-600 text-white rounded text-center">Close</a>
                </div>
            </div>
